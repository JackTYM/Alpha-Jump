...
public class CountdownHandler : MonoBehaviour
{
    ...
    void Update()
    {
        if (gameObject.activeSelf) { // check if the gameObject the script is attached to is active
            if (countdownTimer.ElapsedMilliseconds/1000 > 3.5) { // check if the countdown time is greater than 3.5 seconds
            ...
            } else if (countdownTimer.ElapsedMilliseconds/1000 > 3) { // check if the countdown time is greater than 3 seconds
                transform.GetChild(1).GetComponent<TMPro.TextMeshProUGUI>().text = "GO!"; // change the text to "GO!"
            } else if (countdownTimer.ElapsedMilliseconds/1000 > 2) { // check if the countdown time is greater than 2 seconds
                transform.GetChild(1).GetComponent<TMPro.TextMeshProUGUI>().text = "1"; // change the text to "1"
            } else if (countdownTimer.ElapsedMilliseconds/1000 > 1) { // check if the countdown time is greater than 1 second
